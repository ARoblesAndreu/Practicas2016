...
public class ListaEnlazada {
	...
	class Nodo {
		 ...
		 * 
		 * @param elem
		 *            - el elemento de información útil a almacenar.
		 */
		 ...
		 * 
		 * @param elem
		 *            - el elemento a añadir. Admite que el elemento a añadir
		 *            sea null.
		 */
		...
		/**
		 * Obtiene el nodo correspondiente al índice. Recorre secuencialmente la
		 * cadena de enlaces.
		 * 
		 * @param indice
		 ...
		 *                - índice no está entre 0 y numElementos-1
		 */
